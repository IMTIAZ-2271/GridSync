...
routes_auth.py, routes_sites.py, routes_issues.py, routes_work_orders.py,
routes_agreements.py, routes_analytics.py -- mirroring one controller per
screen. Three conventions govern all of them.
